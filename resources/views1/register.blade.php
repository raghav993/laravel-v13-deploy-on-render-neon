...
<head>
  ...
  <style>
    ...
    * {
    ...
    .aside h1 {
      font: 600 clamp(2rem, 4vw, 3.3rem) Fraunces, serif;
      line-height: 1.1;
      margin: 25px 0 16px
    }
    ...
    .h {
      font: 600 2.1rem Fraunces, serif;
      margin: 0 0 6px
    }
  ...
  <div class="page">
    <aside class="aside">
      ...
      <div>
        ...
        <br><br>
        <h2 class="headline">अपने घर के काम के लिए <em>सही मदद</em> ढूंढें।</h2>
    ...
    <main class="main">
      <div class="card">
        ...
        <h1 class="h">Sahayika पर जुड़ें</h1>
        <p class="sub">पहले बताएं कि आप किस तरह का account बनाना चाहते हैं।</p>

        @if($errors->any())<div class="errors"><strong>कृपया ये details ठीक करें:</strong>
        ...
        <form method="POST" action="{{ route('register.store') }}">
          ...
          <section id="helperFields" class="helper {{ old('role')==='helper'?'show':'' }}">
            <div class="grid">
              <div class="field"><label for="gender">Gender</label><select id="gender" name="gender">
            ...
            <div class="grid">
              <div class="field"><label for="work_type">Work type</label><select id="work_type" name="work_type">
              ...
              <div class="field"><label for="salary_type">Salary type</label><select id="salary_type" name="salary_type">
                  <option value="monthly">Monthly</option>
                  <option value="daily">Daily</option>
                  <option value="hourly">Hourly</option>
                </select></div>
            </div>
            <div class="field"><label>आप कौन-सी services दे सकती/सकते हैं?</label>
              <div class="services">@foreach($services as $service)<label class="service"><input type="checkbox" name="service_ids[]" value="{{ $service->id }}" @checked(in_array($service->id, old('service_ids',[])))> {{ $service->name_hi ?: $service->name }}</label>@endforeach</div>
            </div>
          ...
          <button class="btn btn-primary" type="submit">Account बनाएं</button>
