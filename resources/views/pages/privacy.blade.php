  ...
  <div class="row g-4 align-items-center mb-5">
    ...
    <div class="col-lg-5 text-center">
      <div class="rounded-4 bg-success-subtle p-4 shadow-sm">
        <img src="{{ asset('assets/img/testimonials/2.png') }}" class="rounded-circle mx-auto mb-3 border border-4 border-white shadow" style="width:180px;height:180px;object-fit:cover;" alt="Privacy">
