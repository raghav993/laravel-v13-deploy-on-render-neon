...
<head>
    ...
    <style>
        ...
        * {
        ...
        .badge.offline { background: #f2eee4; color: #7a7263 }
        .badge .dot { width: 7px; height: 7px; border-radius: 50%; background: #2f9e5c }
        .badge.offline .dot { background: #a39c8c }
        ...
        .box h2 i { color: var(--gold-dark); font-size: 1rem }
        .bio { color: rgba(22, 48, 46, .72); line-height: 1.7; margin: 0 }
